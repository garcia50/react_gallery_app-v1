...
export default class App extends Component {
  ...
  performSearch = (query = 'scenic', istrue = false) => {
        ...
        <div className="container">
          ...
          <Nav istrue={this.isTrue}  onClick={this.performSearch} />
          {
            ...
            <Switch>
              ...
              <Route path="/:query" render={ ({match}) => <Gallery testtt={match} search={this.performSearch(match.params.query)} title={match.params.query.toUpperCase()} data={this.state.imgs} /> } />  
